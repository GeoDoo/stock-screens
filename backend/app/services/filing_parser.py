...
class FilingParser:
    ...
    XBRL_MAPPINGS = {
        ...
        "total_liabilities": ["us-gaap:Liabilities", "us-gaap:LiabilitiesAndStockholdersEquity", "us-gaap:TotalLiabilities", "us-gaap:LiabilitiesTotal"],
        ...
        "operating_income": ["us-gaap:OperatingIncomeLoss", "us-gaap:OperatingExpenses"],
        ...
        "interest_expense": ["us-gaap:InterestExpense", "us-gaap:InterestExpenseDebt", "us-gaap:InterestExpenseNet", "us-gaap:InterestExpenseShortTermBorrowings", "us-gaap:InterestAndDebtExpense", "us-gaap:InterestIncomeExpenseNet"],
